...
namespace RVO
{
    ...
    public struct Vector2
    {
        ...
        public static explicit operator Godot.Vector2(Vector2 vec){
            return new Godot.Vector2(vec.x_, vec.y_);
        }
        public static explicit operator Vector2(Godot.Vector2 vec){
